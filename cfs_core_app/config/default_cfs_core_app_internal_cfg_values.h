...
#define CFS_CORE_APP_UPLINK_MAX_RESTARTS              3
#define CFS_CORE_APP_UPLINK_APP_NAME   "uplink_app"
#define CFS_CORE_APP_LORA_RESTART_INTERVAL_MS      5000
#define CFS_CORE_APP_LORA_MAX_RESTARTS                3
#define CFS_CORE_APP_LORA_APP_NAME     "lora_tdm_app"
