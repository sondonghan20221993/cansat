...
**mavlink_bridge_app 슬라이스(미착수)**: `SET_FLIGHT_MODE_CC` 수신 → PX4 `COMMAND_LONG`/`MAV_CMD_DO_SET_MODE`(176) 전송(HOVER→AUTO/LOITER, WAYPOINT→AUTO/MISSION+`MISSION_SET_CURRENT`, LAND→AUTO/LAND). 실외 원형비행 실기 검증만 하드웨어 대기. 스코핑: `../route_2pass_gps_correction_scoping_2026-07-22_completed.md` | 지상 연산 + 3-모드 + PX4 매핑 확정 |
